package com.demo.test.testcases2.login;
...
public class LoginPage_001_LoginSuccessFunction_Test extends BaseParpare{
  ...
  public void loginSuccessFunction(Map<String, String> data) {
	  ...
	  //验证码
	  LoginPageHelper.typeVerificationCode(seleniumUtil, data.get("VCODE"));
	  //等待首页元素显示出来
	  HomePageHelper.waitHomePageLoad(seleniumUtil, timeOut);
	  //检查用户名是不是期望的"jojo"
	  HomePageHelper.checkUserName(seleniumUtil, timeOut, data.get("EXPECT"));
  }
}
